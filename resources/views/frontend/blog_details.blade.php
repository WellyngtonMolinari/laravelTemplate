...
@endphp
@section('title')
Detalhes Blog | {{ $homeslides->title }}
@endsection
          ...
          <div class="row g-5">
              ...
              <div class="meta-top">
                <ul>
                  ...
                  <li class="d-flex align-items-center"><i class="bi bi-person"></i> <a href="blog-details.html">Publicado em:</a></li>
                  <li class="d-flex align-items-center"><i class="bi bi-clock"></i> <time>{{ Carbon\Carbon::parse($blogs->created_at)->format('d/m/Y') }}</time></li>
          ...
          <div class="col-lg-4">
            ...
            <div class="sidebar">
              ...
              <div class="sidebar-item tags">
                ...
                <ul class="mt-3">
                  <li><a href="#">{{ $blogs->blog_tags }}</a></li>
                </ul>
